...
import os #🅡🅤🅛🅐 ​ 🅧
import time #api vip
import threading #สคริปต์ Vip
from requests import get #ทำโดย 🅡🅤🅛🅐 ​ 🅧
from re import search #𝙎𝙋𝘼𝙈 𝙎𝙈𝙎 𝟮𝟮 𝘼𝙋𝙄
from requests import Session #🅡🅤🅛🅐 ​ 🅧
from threading import Thread #RULA X NO.1
os.system('clear') #🅡🅤🅛🅐 ​ 🅧
print("")
os.system("clear")
print ("")
print ("\033[1;96mRULA X ยิงเบอร์ 22 API")
print ("")
...
if (jam < 101):
	...
	print ("")
	print (" \033[91mCan Spam maximum  100 messages ทำโดย 🅡🅤🅛🅐 ​ 🅧 ")